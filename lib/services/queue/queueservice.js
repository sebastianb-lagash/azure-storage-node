...
/**
* Adds a new message to the back of the message queue. WITHOUT SERIALIZE MESSAGE!
...
* });
*/
QueueService.prototype.createMessageWithoutSerialize = function (queue, messageText, optionsOrCallback, callback) {
  var userOptions;
  azureutil.normalizeArgs(optionsOrCallback, callback, function (o, c) { userOptions = o; callback = c; });
  ...
  var xmlMessageDescriptor = QueueMessageResult.serialize('', this.messageEncoder);

//  var xmlMessageDescriptor = QueueMessageResult.serialize(messageText, this.messageEncoder);
  xmlMessageDescriptor = xmlMessageDescriptor.replace('&quot;','"');
  var options = extend(true, {}, userOptions);
